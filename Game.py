...
class Game:
    ...
    def handleActionCard(self, card : Card, player, chosen=None):
        match card.value:
            case 'Second Chance': 
                self.handleSecondChanceAction(player, card)
            case 'Freeze':
                self.handleFreezeAction(chosen, card)
            case 'Flip Three': 
                self.handleFlipThreeAction(chosen, card)
    ...
    def handleDuplicateNumberCard(self, card : Card, player):
